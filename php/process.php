...
class Ajax_Contact_Form {
     ...
     * @var string
     */
    protected $address_destination = 'haibrahmanov@scanex.ru';
    /**
     * Message subject
     *
     * @var string
     */
    protected $message_subject = 'Запрос услуги Карта Пожаров PRO';
    /**
    ...
    protected $strings = array(
        'body'              => '
            ...
            <p><strong>Организация:</strong> <br> {{organization}}</p>',
        'success'           => 'Спасибо! Очень скоро Мы свяжемся с Вами.',
        'error'             => 'Извините, сообщение не было отпрвлено. Проверьте конфигурацию почты PHP сервера.',
        'demo'              => 'This is demo message from PHP',
        'header_injection'  => 'Header injection detected.',
        'enter_name'        => 'Пожалуйста, введите Ваше имя.',
        'enter_email'       => 'Пожалуйста, введите действительный адрес электронной почты.',
    ...
    public function __construct() {
        ...
        $organization = nl2br($organization, false); // false gives <br>, true gives <br />
